...
Jika uang yang dimiliki kurang dari 50000 maka tampilkan "Mohon maaf, uang tidak cukup"
    ...
    -dan akan membeli barang-barang yang sedang SALE masing-masing 1,
     jika uang yang dimilikinya masih cukup.
...
function shoppingTime(memberId, money) {
    ...
    var objArr = {};
    objArr.memberId = memberId;
    objArr.money = money;
    objArr.listPurchased = barang;
    objArr.changeMoney = uang;
